...
EXEC InserirPlataforma 'Computador'
GO
...
--certa
CREATE PROCEDURE AlterarPlataforma (@NomeAltPla NVARCHAR(50), @NomePlataforma NVARCHAR(50))
AS
UPDATE Plataformas
SET Nome_Plataforma = @NomePlataforma
WHERE Nome_Plataforma = @NomeAltPla
GO
